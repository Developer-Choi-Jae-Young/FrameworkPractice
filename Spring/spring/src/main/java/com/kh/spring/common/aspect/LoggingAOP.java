...
@Aspect					//@Aspect : 해당 클래스가 aspect라는 것을 표시
@Component				//@Component : 스프링이 해당 클래스(빈)을 찾을 수 있도록 표시(빈에 등록)
...
public class LoggingAOP {
	 ...
	 * 		@Around		: 대상 메소드를 감싸서 메소드 호출 전/후에 Advice를 실행 한다.
	 * 		@AfterReturing : 대상 메소드가 정상적으로 반환된 후에 Advice가 실행 된다.
	...
	//		대상 : com.kh.spring 피키지 하위 패키지 중 controller 내에 있는 모든 클래스의 모든 메소드
